...
public class ProductCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        final String name;
        final int quantity;
        final String supplier_phone,supplier_name;
        final int price;
        ...
        ;
        supplier_phone = cursor.getString(cursor.getColumnIndex(ProductEntry.SUPPLIER_PHONE));
        supplier_name = cursor.getString(cursor.getColumnIndex(ProductEntry.SUPPLIER_NAME));
                ...
                builder.setPositiveButton(mainActivity.getString(R.string.confirm), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (quantity - subtractedValue >= 0) {
                            mainActivity.sellButton(id, name, price,supplier_name, supplier_phone, quantity, subtractedValue);
